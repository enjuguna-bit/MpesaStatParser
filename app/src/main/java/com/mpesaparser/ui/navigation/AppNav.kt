...
sealed class AppScreen(
    ...
    data object Transactions : AppScreen("transactions", "Transactions", Icons.AutoMirrored.Filled.ListAlt)
    data object Rules : AppScreen("rules", "Rules", Icons.AutoMirrored.Filled.Rule)
